...
public class DataShareStep1 {
    ...
    public Step step1 () {
        return new StepBuilder("step1", jobRepository)
                ...
                .reader(dataShareReader1())
                .processor(dataShareProcessor)
                // lister 등록
                .writer(member -> log.info("step1 writer member={}", member))
                .listener(promotionListener)
                .build();
    }

    @Bean
    public JdbcCursorItemReader<Member> dataShareReader1() {
